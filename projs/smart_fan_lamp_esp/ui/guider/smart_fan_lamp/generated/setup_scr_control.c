...
void setup_scr_control(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->control_slider_2, 23, 121);
	lv_obj_set_size(ui->control_slider_2, 214, 52);

	//Write style for control_slider_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->control_slider_2, 92, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_opa(ui->control_slider_2, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->control_slider_2, lv_color_hex(0xffffff), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->control_slider_2, LV_GRAD_DIR_HOR, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->control_slider_2, lv_color_hex(0xff6500), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_main_stop(ui->control_slider_2, 0, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_stop(ui->control_slider_2, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_opa(ui->control_slider_2, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->control_imgbtn_1, 106, 17);
	...
	lv_obj_set_pos(ui->control_imgbtn_2, 190, 17);
	lv_obj_set_size(ui->control_imgbtn_2, 50, 50);
	...
	ui->control_imgbtn_3_label = lv_label_create(ui->control_imgbtn_3);
	lv_label_set_text(ui->control_imgbtn_3_label, "");
	lv_label_set_long_mode(ui->control_imgbtn_3_label, LV_LABEL_LONG_WRAP);
	lv_obj_align(ui->control_imgbtn_3_label, LV_ALIGN_CENTER, 0, 0);
	lv_obj_set_style_pad_all(ui->control_imgbtn_3, 0, LV_STATE_DEFAULT);
	lv_obj_set_pos(ui->control_imgbtn_3, 23, 67);
	lv_obj_set_size(ui->control_imgbtn_3, 50, 50);

	//Write style for control_imgbtn_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_text_color(ui->control_imgbtn_3, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->control_imgbtn_3, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->control_imgbtn_3, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_clip_corner(ui->control_imgbtn_3, true, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style for control_imgbtn_3, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
	lv_obj_set_style_img_recolor_opa(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_img_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_color(ui->control_imgbtn_3, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->control_imgbtn_3, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_shadow_width(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style for control_imgbtn_3, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_img_recolor_opa(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_img_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_color(ui->control_imgbtn_3, lv_color_hex(0xFF33FF), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->control_imgbtn_3, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_shadow_width(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for control_imgbtn_3, Part: LV_PART_MAIN, State: LV_IMGBTN_STATE_RELEASED.
	lv_obj_set_style_img_recolor_opa(ui->control_imgbtn_3, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
	lv_obj_set_style_img_opa(ui->control_imgbtn_3, 255, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
	...
	lv_obj_set_pos(ui->control_imgbtn_4, 106, 67);
