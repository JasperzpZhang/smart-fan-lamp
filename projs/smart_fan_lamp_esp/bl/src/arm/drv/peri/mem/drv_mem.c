...
///* Local defines */
//#if MEM_RTOS
//    #define MEM_MUTEX_INIT()    do{ \
//                                    osMutexDef(MemMutex); \
//                                    s_xMemMutex = osMutexCreate(osMutex(MemMutex)); \
//                                }while(0)
//    #define MEM_LOCK()          osMutexWait(s_xMemMutex, osWaitForever)
...
/* Local defines */
#if MEM_RTOS
    static osMutexId_t s_xMemMutex;  // ÉùÃ÷»¥³âËø±äÁ¿
